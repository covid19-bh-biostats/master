...
The spread of SARS-CoV-2 to other territories in China and other countries in Asia and Europe revealed the pandemic potential of SARS-CoV-2 and we can find several mathematical models to  forecast the spread of the disease to other territories [@Wu_Jan2020][@Li_Mar2020][@Zhang_April2020]. Compartmental models are commonly used to model epidemics, a Susceptible-Exposed-Infectious-Recovered metapopulation models have been used to describe the dynamics of covid-19 [@Li_Mar2020][Heiden_March2020][Walker_March2020][@Casares_March2020]. 
